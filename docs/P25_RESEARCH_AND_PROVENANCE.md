...
| [OP25 Phase II DUID implementation at `71abcd0`](https://github.com/boatbod/op25/blob/71abcd0ead32f86f51615ea6cc8a6a4dba4c949a/op25/gr-op25_repeater/lib/p25p2_duid.cc) | GPL-3.0-or-later in the reviewed file header | The four DUID dibits are separated within the 180-dibit burst and use a one-error-correcting eight-bit codeword. Voice and associated-control burst types must be distinguished before payload handling. | Behavior was cross-checked only. OrcSDR uses an independently written, table-free extended-Hamming decoder and does not incorporate OP25's lookup table or source. |
